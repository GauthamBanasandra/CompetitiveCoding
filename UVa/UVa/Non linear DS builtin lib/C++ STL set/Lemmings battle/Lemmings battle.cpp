...
class deadly_war {
public:
    deadly_war(std::multiset<lemmings, lemmings_comparator> &&blue_lemmings,
...
void print_lemmings(std::multiset<lemmings, lemmings_comparator> green_lemmings,
                    std::multiset<lemmings, lemmings_comparator> blue_lemmings) {
